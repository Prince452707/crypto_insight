...
// import 'CryptoLearningScreen.dart';
// import 'theme.dart';
// import 'screen.dart/search.dart';
...
// import 'screen.dart/search.dart';
// import 'screen.dart/CryptocurrencyListItem.dart';
// import 'auth_screen.dart'; // Import the new AuthScreen
...
//               }
//               if (snapshot.hasData) {
//                 return SearchScreen(); // User is logged in
//               }
//               return AuthScreen(); // User needs to log in or sign up
//             },
//           ),
//           routes: {
...
//   try {
//     await Firebase.initializeApp();
//     await FirebaseAuth.instance.signOut(); // Clear Firebase auth state
...
//     runApp(FailureApp(error: e.toString()));
//     return;
//   }
//   runApp(
//     ChangeNotifierProvider(
...
//   final String error;
//   FailureApp({required this.error});
...
// import 'package:crypto_insight/CryptoLearningScreen.dart';
// import 'package:flutter/material.dart';
// import 'package:firebase_core/firebase_core.dart';
// import 'package:provider/provider.dart';
// import 'splash_screen.dart'; // New splash screen
// import 'auth_screen.dart';
// import 'package:crypto_insight/screen.dart/search.dart';
// import 'profilescreen.dart';
// import 'package:crypto_insight/screen.dart/bookmarks.dart';
// import 'package:crypto_insight/profilescreen.dart';
// import 'auth_screen.dart';
// import 'profilescreen.dart';
// import 'auth_screen.dart';
...
// import 'screen.dart/search.dart';
// import 'profilescreen.dart';
// import 'screen.dart/bookmarks.dart';
// import 'CryptoLearningScreen.dart';
// import 'theme.dart';
...
//               '/profile': (context) =>  ProfileScreen(),
//               '/bookmarks': (context) =>  BookmarksScreen(),
//               '/learning': (context) => const CryptoLearningScreen(),
//               '/settings': (context) => const SettingsScreen(), // Assuming this exists
//             },
//             debugShowCheckedModeBanner: false,
//           );
//         },
...
// // Placeholder for SettingsScreen (add your actual implementation)
// class SettingsScreen extends StatelessWidget {
...
// import 'package:crypto_insight/drawer/CryptoLearningScreen.dart';
// import 'package:crypto_insight/auth_screen.dart';
// import 'package:crypto_insight/drawer/help&support.dart';
// import 'package:crypto_insight/drawer/profilescreen.dart';
// import 'package:crypto_insight/screen.dart/CryptocurrencyListItem.dart';
// import 'package:crypto_insight/drawer/bookmarks.dart';
// import 'package:crypto_insight/drawer/search.dart';
// import 'package:crypto_insight/splash_screen.dart';
// import 'package:flutter/material.dart';
// import 'package:firebase_core/firebase_core.dart';
// import 'package:provider/provider.dart';
...
//       );
//     } catch (e) {
//       setState(() => _error = 'Error initializing Firebase: $e');
//     } finally {
//       setState(() => _isLoading = false);
//     }
//   }
...
import 'package:crypto_insight/drawer/help&support.dart';
import 'package:crypto_insight/drawer/profilescreen.dart';
import 'package:crypto_insight/screen.dart/CryptocurrencyListItem.dart'; // Check if this is needed
import 'package:crypto_insight/drawer/bookmarks.dart';
import 'package:crypto_insight/drawer/search.dart';
import 'package:crypto_insight/splash_screen.dart';
import 'package:flutter/material.dart';
    ...
    return Consumer<ThemeProvider>(
      builder: (context, themeProvider, _) {
        return MaterialApp(
          title: 'Crypto Insights',
          theme: themeProvider.currentTheme,
          initialRoute: '/splash', // Starts at SplashScreen
          routes: {
            '/': (context) => const SplashScreen(), // Fallback route
            '/splash': (context) => const SplashScreen(),
            '/auth': (context) => const AuthScreen(),
            '/search': (context) => SearchScreen(), // Added const for consistency
