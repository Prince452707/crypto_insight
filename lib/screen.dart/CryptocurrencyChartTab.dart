...
import 'package:flutter/material.dart';
import 'package:intl/intl.dart';
import '../service.dart/api.dart'; // Assuming this contains ApiService
...
class _CryptocurrencyChartTabState extends State<CryptocurrencyChartTab> {
  ...
  Future<void> fetchMarketChart() async {
    ...
    try {
      ...
      setState(() => isChartLoading = false);
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Failed to fetch market chart data: $e')),
      );
    }
  }
  ...
  Future<void> fetchAIAnalysis() async {
    try {
      final analysis = await AIService.generateComprehensiveAnalysis(
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Failed to fetch AI analysis: $e')),
      );
    }
  }
        ...
        Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              if (aiAnalysis != null && aiAnalysis!['prediction'] != null) ...[
